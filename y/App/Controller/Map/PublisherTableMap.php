...
use App\Controller\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'App.Controller.Map.PublisherTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\Controller\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'App.Controller.Publisher';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\App\\Controller\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\App\\Controller\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Controller\Publisher) { // it's a model object
