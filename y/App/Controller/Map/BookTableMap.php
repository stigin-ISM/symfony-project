...
class BookTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'App.Controller.Map.BookTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\Controller\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'App.Controller.Book';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\App\\Controller\\Book');
        $this->setPackage('App.Controller');
    ...
    {
        $this->addRelation('Publisher', '\\App\\Controller\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\App\\Controller\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Controller\Book) { // it's a model object
