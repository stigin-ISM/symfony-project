...
use App\Controller\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'App.Controller.Map.AuthorTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\Controller\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'App.Controller.Author';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\App\\Controller\\Author');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Controller\Author) { // it's a model object
