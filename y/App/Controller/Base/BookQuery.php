...
use \Exception;
use \PDO;
use App\Controller\Book as ChildBook;
use App\Controller\BookQuery as ChildBookQuery;
use App\Controller\Map\BookTableMap;
 ...
 *
 * @method     \App\Controller\PublisherQuery|\App\Controller\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Controller\Base\BookQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Controller\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\Controller\Publisher object
     *
     * @param \App\Controller\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($publisher instanceof \App\Controller\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \App\Controller\Publisher or Collection');
        }
    }
     ...
     *
     * @return \App\Controller\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\App\Controller\PublisherQuery');
    }

    /**
     * Use the Publisher relation Publisher object
     *
     * @param callable(\App\Controller\PublisherQuery):\App\Controller\PublisherQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \App\Controller\PublisherQuery The inner query object of the EXISTS statement
     */
    public function usePublisherExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \App\Controller\PublisherQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \App\Controller\PublisherQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \App\Controller\PublisherQuery The inner query object of the IN statement
     */
     ...
     *
     * @return \App\Controller\PublisherQuery The inner query object of the NOT IN statement
     */
    ...
    /**
     * Filter the query by a related \App\Controller\Author object
     *
     * @param \App\Controller\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($author instanceof \App\Controller\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \App\Controller\Author or Collection');
        }
    }
     ...
     * @param string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\Controller\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\App\Controller\AuthorQuery');
    }

    /**
     * Use the Author relation Author object
     *
     * @param callable(\App\Controller\AuthorQuery):\App\Controller\AuthorQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \App\Controller\AuthorQuery The inner query object of the EXISTS statement
     */
    public function useAuthorExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \App\Controller\AuthorQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \App\Controller\AuthorQuery The inner query object of the NOT EXISTS statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \App\Controller\AuthorQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \App\Controller\AuthorQuery The inner query object of the NOT IN statement
     */
