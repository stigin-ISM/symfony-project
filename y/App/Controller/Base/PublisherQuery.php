...
use \Exception;
use \PDO;
use App\Controller\Publisher as ChildPublisher;
use App\Controller\PublisherQuery as ChildPublisherQuery;
use App\Controller\Map\PublisherTableMap;
 ...
 *
 * @method     \App\Controller\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Controller\Base\PublisherQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Controller\\Publisher', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\Controller\Book object
     *
     * @param \App\Controller\Book|ObjectCollection $book the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    ...
    {
        if ($book instanceof \App\Controller\Book) {
            $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \App\Controller\Book or Collection');
        }
    }
     ...
     *
     * @return \App\Controller\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\App\Controller\BookQuery');
    }

    /**
     * Use the Book relation Book object
     *
     * @param callable(\App\Controller\BookQuery):\App\Controller\BookQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \App\Controller\BookQuery The inner query object of the EXISTS statement
     */
    public function useBookExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \App\Controller\BookQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \App\Controller\BookQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \App\Controller\BookQuery The inner query object of the IN statement
     */
     ...
     *
     * @return \App\Controller\BookQuery The inner query object of the NOT IN statement
     */
