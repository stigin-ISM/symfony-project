...
use \Exception;
use \PDO;
use App\Controller\Author as ChildAuthor;
use App\Controller\AuthorQuery as ChildAuthorQuery;
use App\Controller\Map\AuthorTableMap;
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Controller\Base\AuthorQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Controller\\Author', $modelAlias = null)
    {
