 ...
 *
 *
 * @package    propel.generator.App.Controller.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Controller\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of App\Controller\Base\Publisher object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Controller\\Publisher'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->booksScheduledForDeletion !== null) {
                if (!$this->booksScheduledForDeletion->isEmpty()) {
                    \App\Controller\BookQuery::create()
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Controller\Publisher (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Controller\Publisher Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initBooks(bool $overrideExisting = true): void
    {
        ...
        $this->collBooks->setModel('\App\Controller\Book');
    }
        ...
        if (null === $this->collBooks || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collBooks) {
                    ...
                    $collBooks->setModel('\App\Controller\Book');
