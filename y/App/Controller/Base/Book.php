...
abstract class Book implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Controller\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of App\Controller\Base\Book object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Controller\\Book'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Controller\Book (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Controller\Book Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
